    ...
    getFallbackPlayers() {
        try {
            ...
            const japanesePlayers = [
                ...
                { name: '三苫薫', fullName: '三苫薫', currentTeam: 'Brighton', position: 'Midfielder', nationality: 'Japan', age: 25, photo: 'https://media.api-sports.io/football/players/106835.png', league: 'PL', englishName: 'Kaoru Mitoma' },
                // ジェフユナイテッド千葉（J1）
                { name: '呉屋大翔', fullName: '呉屋大翔', currentTeam: 'ジェフユナイテッド千葉', position: 'Forward', nationality: 'Japan', age: 30, photo: 'https://ui-avatars.com/api/?name=呉屋大翔&size=128&background=22c55e&color=0d1117&bold=true', league: 'J1', englishName: 'Daito Kureya' },
                { name: '横山暁之', fullName: '横山暁之', currentTeam: 'ジェフユナイテッド千葉', position: 'Midfielder', nationality: 'Japan', age: 28, photo: 'https://ui-avatars.com/api/?name=横山暁之&size=128&background=22c55e&color=0d1117&bold=true', league: 'J1', englishName: 'Akiyuki Yokoyama' },
                { name: '風間宏矢', fullName: '風間宏矢', currentTeam: 'ジェフユナイテッド千葉', position: 'Midfielder', nationality: 'Japan', age: 27, photo: 'https://ui-avatars.com/api/?name=風間宏矢&size=128&background=22c55e&color=0d1117&bold=true', league: 'J1', englishName: 'Hiroyuki Kazama' },
                { name: '鈴木大輔', fullName: '鈴木大輔', currentTeam: 'ジェフユナイテッド千葉', position: 'Defender', nationality: 'Japan', age: 35, photo: 'https://ui-avatars.com/api/?name=鈴木大輔&size=128&background=22c55e&color=0d1117&bold=true', league: 'J1', englishName: 'Daisuke Suzuki' },
                { name: '米倉恒貴', fullName: '米倉恒貴', currentTeam: 'ジェフユナイテッド千葉', position: 'Defender', nationality: 'Japan', age: 28, photo: 'https://ui-avatars.com/api/?name=米倉恒貴&size=128&background=22c55e&color=0d1117&bold=true', league: 'J1', englishName: 'Tsuneaki Yonekura' },
