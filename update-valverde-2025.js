...
/**
 * API-Footballからフェデリコ・バルベルデの2025-26シーズンデータを取得してplayers.jsonに反映
 */
...
const PLAYER_ID = 756; // Federico Valverde
...
async function main() {
    console.log('🔍 API-Footballからフェデリコ・バルベルデの2025シーズンデータを取得中...');
    ...
    if (idx === -1) {
        console.error('❌ players.json にバルベルデが見つかりません');
        process.exit(1);
    }
